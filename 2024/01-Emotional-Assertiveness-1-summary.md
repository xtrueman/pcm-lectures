...
### 1. Введение в эмоциональную ассертивность:

*   Необходимость управления эмоциями для эффективного анализа и принятия решений.
*   Разбор стратегий принятия решений на примере фильма "Стажер".

### 2. Анализ принятия решений Джулс Остин ("Стажер"):
...
*   **Решение задач в моменте (в зоне мотивации):**
    *   Отказ от стажеров:
        *   Оборудована ассоциациями с предыдущими травмами (перенос на пожилых людей). Изначально отказывается от Бена, потому что он пожилой, тем самым проецируя на него перенос к родителям.
    ...
    * Исходя из этого можно предположить, что фаза у Джулс – деятель (стоит сравнить с прошлыми определениями фазы на курсе).
...
### 3. Анализ принятия решений Бена Уитакера ("Стажер"):
...
### 4. Сравнение успешности Джулс и Бена в решении задач и факторы, влияющие на принятие решений:
...
### 5. Роль лимбической системы и префронтальной коры в принятии решений:
...
### 6. Упражнение на быстрые эмоциональные реакции:
...
### 7. Формирование социальных программ мозгом:
...
### 8. Роль стресса в принятии решений:
...
### 9. Элементы эмоциональной ассертивности:
...
### 10. Обсуждение трендов в психологии (детские травмы, "никто никому ничего не должен", эмпатия):
...
### 12. Проблема "Никто никому ничего не должен" и теория поколений:
...
### 14. Общая картина принятия решений:
...
### 15. Заключение и задача про развитие взаимодействия эмоциональной и мыслящей частей:
...
### 16. Ипостаси развития эмоциональной ассертивности (будут рассматриваться на протяжении года):
...
### 18. Разбор вопросов и примеров аудитории:
