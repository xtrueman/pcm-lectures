...
**II. Анализ дисгармоничных сочетаний и низкоресурсных типов личности (на примере Тони из фильма):**

*   **Типирование Тони:** Логик (база) - Деятель (фаза), без "бунтаря" (который присутствует у Пауля).
...
**III. Третья степень стресса (на примере Джима Уитекера):**
...
**IV. Эмоциональная проблематика (на примере Джима Уитекера):**
...
**VI. Упорный тип личности в стрессе:**
...
**VII. Стратегии работы с упорным в стрессе:**
...
*   Сочетаемость одних знаков зодиака и плохая сочетаемость других. Этот момент надо помнить. Но про отношения вы еще поговорим.
