...
### I. Введение. Обсуждение фильма и паттернов провала.
...
### II. Анализ личности доктора Ватсона.
...
*   **Сценарий "почти два"**: Включается у людей с сочетанием "душевный + логик" или "душевный + упорный". У Ватсона: Когда ему говорят, "Вау, батенька, это вы, видать, крутой стрелок", а он отвечает, "Да мне просто повезло".
    ...
    *   *Пример:* Лектор рассказывает про себя, когда поменяла фазу с деятеля на упорного — сняла все свои фотографии и убрала в шкаф все награды. Стало стыдно получать большие гонорары, старалась тут же отдать их на благотворительность.
    *   Для социума этот паттерн безопасен, страдает только сам носитель, сливая энергию.
...
### IV. Паттерны провала (продолжение)
...
### V. Обсуждение и заполнение таблицы типов личности.
...
### VI. Проблематика (мешающие факторы) для каждого типа личности.
...
### VII. Негативные намерения (когда не хватает позитивной энергии).
...
### VIII. Диверсионное поведение (когда человек пошел в минусы).
...
### IX. Жертвы (Чем жертвует каждый тип личности).
...
### X. Состояние в стрессе "-3" (во что каждый из них проваливается в данном случае).
...
### XII. Подготовка к следующему занятию:
...
*   Могут ли коллеги начать приставать в чате того, что получилось обобщиться